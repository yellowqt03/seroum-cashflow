    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">매출 리포트</h1>
            <p className="text-sm md:text-base text-gray-600 mt-1">상세 매출 분석 및 통계</p>
          </div>
        </div>
      ...
      {!loading && totalStats && (
        <>
          ...
          {salesData && (
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2">
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900">기간별 매출 추이</h2>
          ...
          {salesData?.discountStats && (
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2">
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900">할인 사용 현황</h2>
